...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#060312] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <div className="mt-6 flex items-center gap-3">
              <a href="https://www.instagram.com/digitalnerdhq" target="_blank" rel="noopener noreferrer" aria-label="Follow on Instagram"
                className="w-9 h-9 rounded-lg bg-white/10 hover:bg-[#ef4444] flex items-center justify-center transition-all duration-200 hover:scale-110" style={{ willChange: 'transform' }}>
              ...
              <a href="https://twitter.com/DigitalNerdHQ" target="_blank" rel="noopener noreferrer" aria-label="Follow on Twitter/X"
                className="w-9 h-9 rounded-lg bg-white/10 hover:bg-[#ef4444] flex items-center justify-center transition-all duration-200 hover:scale-110" style={{ willChange: 'transform' }}>
              ...
              <a href="https://www.linkedin.com/company/digitalnerdhq" target="_blank" rel="noopener noreferrer" aria-label="Follow on LinkedIn"
                className="w-9 h-9 rounded-lg bg-white/10 hover:bg-[#ef4444] flex items-center justify-center transition-all duration-200 hover:scale-110" style={{ willChange: 'transform' }}>
          ...
          {/* Blog column */}
          <div>
            <h3 className="text-xs font-semibold uppercase tracking-widest text-white/40 mb-4">Blog</h3>
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-white/30">&copy; {currentYear} DigitalNerdHQ. All rights reserved.</p>
          <p className="text-xs text-white/25">
            Built with{' '}
            <a href="https://nextjs.org" className="hover:text-white/50 transition-colors">Next.js</a>
            {' & '}
            <a href="https://hashnode.com" className="hover:text-white/50 transition-colors">Hashnode</a>
          </p>
        </div>
      </div>
    </footer>
